        ...
        <div class="register-box-body">
            ...
            <form action="views/process/data-process.php" method="post">
                <div class="form-group has-feedback">
                    <input type="hidden" class="form-control" name="email" value="<?php echo $_SESSION['mm']?>">
                    <input type="text" name="otp" class="form-control" placeholder="OTP" required><br>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button type="submit" name="change_recover_password" class="btn btn-primary btn-block btn-flat">Change password</button>
                    </div>
                </div>
            </form>
        </div>
