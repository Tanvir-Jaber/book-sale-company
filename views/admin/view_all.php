    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">View all accounts</li>
            </ol>
        </section>
                                ...
                                if ($list){
                                    foreach ($list as $lists){
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                                <a href="../process/data-process.php?moveToTrash=<?php echo $lists->no; ?>" style="border-radius: 20%;font-size: 10px" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
