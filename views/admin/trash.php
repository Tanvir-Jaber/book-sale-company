                                ...
                                if ($list){
                                    foreach ($list as $lists){
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                                <a href="../process/data-process.php?Active_yes_userAccount=<?php echo $lists->no; ?>"style="border-radius: 20%;font-size: 10px" class="btn btn-success"><i class="fa fa-check"></i></a>
