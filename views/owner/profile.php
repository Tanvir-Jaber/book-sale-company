...
if ($details_shopOwners){
    ...
    $shop_name = $details_shopOwners->shop_name;
}
else{
    $address="";$city="";$state="";$pnumber="";$shop_name = "";
}
                                ...
                                <div class="active tab-pane" id="activity">
                                    <form id="" action="../process/data-process.php" method="post" class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div style="margin-top: 10px" class="col-sm-12">
                                                <input type="text" class="form-control" name="shop_name" value="<?php echo $shop_name?>" PLACEHOLDER="Shop Name" required>
                                            </div>
                                            <div style="margin-top: 10px" class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <button type="submit" name="change_member_profile" class="form-control btn w-100 btn-info">Update Profile</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
