    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div style="margin-left: auto;margin-right: auto;" class="row">
                ...
                <?php
                $list_all_books = $dbmanipulate->viewAllBooksForUsers();
                $i = 0;
                if ($list_all_books){
                    foreach ($list_all_books as $list_all_book){
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div style="margin-bottom: 10px" class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    <h5  style="text-align: left;margin-bottom:0;display: block;width:200px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width: 30ch!important;" class="card-title text-center"><b>Title: <?php echo $list_all_books[$i]->title ?></b></h5>
                                    <span style="text-align: left" class="card-text"><b>Writer Name: <?php echo $list_all_books[$i]->writer_name ?><b></span>
                                    <?php
