...
if (isset($_SESSION ['Sid']) && isset($_SESSION ['Sname']) && isset($_SESSION ['Semail'])){
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <input type="hidden" class="user_name" value="<?php echo $details->name?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table  class="table table-bordered table-condensed">
                        ...
                        <?php
                        $list_all_books = $dbmanipulate->viewBuyersInfo();
                        $i = 0;
                        if ($list_all_books){
                            foreach ($list_all_books as $list_all_book){
                                ?>
                                <tr>
                                    <td class="attrName" style="padding: 10px" class="active"><?php echo $list_all_books[$i]->name ?>  <span class="message-show-on-alert badge-danger badge"></span></td>
                                    <td style="padding: 10px" class="danger"><?php echo $list_all_books[$i]->email ?></td>
                                    <td style="padding: 10px" class="success"><?php echo $list_all_books[$i]->position ?></td>
                                    <td class="info">
                                        <button data-id="<?php echo $list_all_books[$i]->no ?>"  class="btn btn-danger btn-sm attrValue show-chat-box-click"><span class="glyphicon glyphicon-send"></span></button>
                                    </td>
                                </tr>
                                <?php
                                $i++;
        ...
        <section style="display:none;position:absolute;right:100px;top: 20px;width: 35%;height: 550px;" class="msger show-chat-box">
            <header class="msger-header">
                <div class="msger-header-title">
                    <i class="fa fa-comment"></i> Message
                </div>
                <div class="msger-header-options btn-close-tool">
                    <span><i class="fa fa-times"></i></span>
                </div>
            </header>
            <main style="height: 450px;" class="msger-chat chatlogs">
            ...
            <form class="msger-inputarea">
                <input type="text" class="msger-input chatMessageSend" placeholder="Enter your message...">
                <button type="button" class="msger-send-btn chatSendBtn">Send</button>
            </form>
        </section>
    </div>
    <?php
                    ...
                    success:function (result) {
                        ...
                        for (var f = 0; f<ary.length; f++) {
                            for (var i = 0; i < datas.length; i++) {
                                if ((datas[i].messageRead == "unseen") && (datas[i].owners_id == ary[f]) ) {
                                    console.log(datas)
                                    $('.attrTable tr').each(function (a, b) {
                                        var name = $('.attrName', b).text();
                                        /*var value = $('.attrValue', b).attr('data-id');*/
                                        if($(".attrValue",b).attr('data-id') == datas[i].owners_id){
                                            j=j+1;
                    ...
                    success: function(data)
                    {
                        ...
                        for(var i =0; i<data.length;i++){
                            if((data[i].message_from) !=null){
                                ...
                                htmlstring +="<div class=\"msg left-msg\">\n" +
                                    "                                    <div class=\"msg-img\" style=\"background-image: url(https://image.flaticon.com/icons/svg/327/327779.svg)\"></div>\n" +
                                    "                                    <div class=\"msg-bubble\">\n" +
                                    "                                    <div class=\"msg-info\">\n" +
                                    "                                    <div class=\"msg-info-name\">" + data[i].users_name + "</div>\n" +
                                    "                                    <div class=\"msg-info-time\">" + tConvert(data[i].time) + "</div>\n" +
                                    "                                </div>\n" +
                                    "                                <div class=\"msg-text\">\n" +
                                    "                                    " + data[i].message_from +
                                    "                            </div>\n" +
                            ...
                            if((data[i].message_to) !=null){
                                htmlstring += "<div class=\"msg right-msg\">\n" +
                                    "                    <div class=\"msg-img\" style=\"background-image: url(https://image.flaticon.com/icons/svg/145/145867.svg)\"></div>\n" +
                                    "                    <div class=\"msg-bubble\">\n" +
                                    "                        <div class=\"msg-info\">\n" +
                                    "                            <div class=\"msg-info-name\">" + data[i].owners_name + "</div>\n" +
                                    "                            <div class=\"msg-info-time\">" + tConvert(data[i].time) + "</div>\n" +
                                    "                        </div>\n" +
                                    "                        <div class=\"msg-text\">\n" +
                                    "                            " + data[i].message_to +
